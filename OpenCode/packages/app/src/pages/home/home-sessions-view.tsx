...
export function HomeSessionsView(props: HomeSessionsViewProps) {
  return (
    ...
    >
      <div class="sticky top-0 z-30 shrink-0 bg-v2-background-bg-base pb-3 pt-4" onWheel={props.onWheel}>
        <HomeSessionSearch {...props} />
        <Suspense>
          <Show when={props.groups().length > 0 && props.canCreateSession()}>
            <div class="pointer-events-none absolute right-0 top-[64px] z-20 flex">
              <ButtonV2
      ...
      <div class="pointer-events-none sticky top-[64px] z-40 h-0 -mr-3">
        <div
          ref={props.onSetThumbTrack}
          data-component="home-session-scroll-track"
          class="relative ml-auto h-[calc(100cqh-64px)] w-3"
        />
      </div>
      <div class="-mr-3 min-h-[calc(100cqh-52px)]">
        <Suspense
          fallback={
            <div class="pt-3">
...
function HomeSessionGroupHeader(props: {
  ...
  return (
    <div
      ref={props.onSetRef}
      class={`
        pointer-events-none sticky top-[64px] flex h-7 min-w-0 items-center justify-between
