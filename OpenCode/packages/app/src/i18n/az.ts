export const dict = {
  ...
  "memory.action.openWorkbench": "Open memory workbench",
  ...
  "memory.session.noTopic.description":
    "A topic is created automatically on the first captured event. You can also archive this session from the workbench.",
