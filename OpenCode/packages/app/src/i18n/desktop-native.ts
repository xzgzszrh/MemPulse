...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.menu.ariaLabel": "MemPulse menu",
  ...
  "desktop.recovery.loadFailed": "MemPulse failed to load",
  "desktop.recovery.terminated": "MemPulse window terminated unexpectedly",
  "desktop.recovery.unresponsive": "MemPulse is not responding",
