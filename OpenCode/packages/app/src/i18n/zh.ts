...
export const dict = {
  ...
  "desktop.menu.ariaLabel": "MemPulse 菜单",
  ...
  "desktop.recovery.loadFailed": "MemPulse 加载失败",
  "desktop.recovery.terminated": "MemPulse 窗口意外终止",
  "desktop.recovery.unresponsive": "MemPulse 未响应",
  ...
  "help.tabs.introduction": "MemPulse Code 采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MemPulse Code 有新版本 ({{version}}) 可安装。",
  ...
  "settings.general.row.language.description": "更改 MemPulse Code 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 MemPulse Code 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 MemPulse Code 跟随系统、浅色或深色主题",
  ...
  "command.memory.open": "打开记忆工作台",
  "session.tab.memory": "记忆",
  "settings.tab.memory": "记忆",
  "memory.title": "记忆",
  "memory.action.cancel": "取消",
  "memory.action.confirm": "确认",
  "memory.action.more": "更多操作",
  "memory.action.next": "下一页",
  "memory.action.openWorkbench": "打开记忆首页",
  "memory.action.previous": "上一页",
  "memory.action.refresh": "刷新",
  "memory.action.retry": "重试",
  "memory.action.search": "搜索记忆",
  "memory.action.viewAll": "查看全部",
  "memory.contract.empty": "尚未记录恢复契约。",
  "memory.contract.missing": "待补全",
  "memory.contract.more": "另有 {{count}} 个字段",
  "memory.contract.pending": "还有 {{count}} 个字段待补全",
  "memory.contract.title": "恢复契约",
  "memory.events.app": "应用",
  "memory.events.attributes": "属性",
  "memory.events.content": "内容",
  "memory.events.empty": "尚未捕获事件。",
  "memory.events.eventId": "事件",
  "memory.events.forget.action": "遗忘事件",
  "memory.events.forget.confirm": "遗忘",
  "memory.events.forget.description": "该事件将被标记为墓碑：不再出现在检索与恢复结果中，删除动作会留下回执。",
  "memory.events.forget.title": "遗忘这个事件？",
  "memory.events.metadata": "元数据",
  "memory.events.move.action": "移动到其他话题",
  "memory.events.move.confirm": "移动",
  "memory.events.move.title": "移动事件",
  "memory.events.olderHits": "更早的匹配",
  "memory.events.source": "来源",
  "memory.events.tool": "工具",
  "memory.events.topic": "话题",
  "memory.eventStatus.success": "成功",
  "memory.eventStatus.failed": "失败",
  "memory.eventStatus.pending": "进行中",
  "memory.eventStatus.unknown": "未知",
  "memory.field.other": "字段",
  "memory.field.outputPreference": "输出偏好",
  "memory.field.templateVersion": "模板版本",
  "memory.filter.all": "全部",
  "memory.governance.checkpoints": "检查点",
  "memory.governance.disputed": "存疑",
  "memory.governance.empty": "暂无记录。",
  "memory.governance.knowledge": "知识版本",
  "memory.governance.preferences": "偏好",
  "memory.governance.receipts": "遗忘回执",
  "memory.governance.receipts.empty": "尚无遗忘记录。",
  "memory.governance.scope": "作用域：{{scope}}",
  "memory.governance.supersedes": "替代 {{id}}",
  "memory.graph.clearSearch": "清除搜索",
  "memory.graph.degree": "关联数",
  "memory.graph.empty": "暂无可绘制的内容",
  "memory.graph.empty.description": "随着话题积累标签与共享实体，图谱会逐步展开。",
  "memory.graph.nodeList": "节点",
  "memory.graph.relatedTopics": "关联话题",
  "memory.graph.relayout": "重新布局",
  "memory.graph.searchPlaceholder": "查找节点",
  "memory.graph.selection": "选中项",
  "memory.graph.selection.empty": "选中一个节点查看详情。拖拽可移动节点，滚轮可缩放。",
  "memory.graph.summary": "{{topics}} 个话题 · {{entities}} 个实体 · {{relations}} 条关系",
  "memory.graph.zoomIn": "放大",
  "memory.graph.zoomOut": "缩小",
  "memory.health.action.done": "已完成",
  "memory.health.action.failed": "操作失败",
  "memory.health.action.reindex": "重建索引",
  "memory.health.action.worker": "执行维护",
  "memory.health.backend": "嵌入后端",
  "memory.health.db": "数据库",
  "memory.health.indexPolicy": "检索准入",
  "memory.health.maintenance": "维护",
  "memory.health.maintenance.hint": "以下操作作用于本地 SQLite 存储。重建索引需要已配置的本地嵌入模型。",
  "memory.health.off": "关",
  "memory.health.ok": "正常",
  "memory.health.on": "开",
  "memory.health.reindex.description":
    "根据已存储的事件重建向量与全文索引。需要已配置的本地嵌入模型，未加载时会直接失败。",
  "memory.health.retrieval": "检索",
  "memory.health.schema": "Schema 版本",
  "memory.health.scope": "作用域",
  "memory.health.sdk": "麒麟 SDK 探测",
  "memory.health.sdk.backend": "后端",
  "memory.health.sdk.dimension": "维度",
  "memory.health.sdk.message": "信息",
  "memory.health.sdk.model": "模型",
  "memory.health.sdk.none": "未配置麒麟 SDK。在记忆服务上设置 MEMPULSE_KYLIN_SDK 后可进行探测。",
  "memory.health.sdk.status": "状态",
  "memory.health.service": "服务",
  "memory.health.storage": "存储",
  "memory.health.topiccore": "TopicCore",
  "memory.health.workspace": "工作区",
  "memory.route.ambiguous": "待判定",
  "memory.route.attach": "已挂载",
  "memory.route.new": "新建",
  "memory.route.resume": "已恢复",
  "memory.route.unknown": "未知",
  "memory.search.empty": "没有匹配结果。",
  "memory.search.placeholder": "搜索记忆",
  "memory.session.captured": "本次会话已捕获",
  "memory.session.captured.empty": "尚未捕获内容。会话进行时，事件会出现在这里。",
  "memory.session.checkpoint.create": "创建检查点",
  "memory.session.checkpoint.revision": "版本 {{revision}}",
  "memory.session.checkpoint.title": "检查点",
  "memory.session.noTopic.description": "请选择或新建持久任务话题，并确认关联。会话创建和首条消息不会自动建立话题。",
  "memory.session.noTopic.title": "本次会话尚无话题",
  "memory.source.configuration": "配置",
  "memory.source.conversation": "对话",
  "memory.source.other": "其他",
  "memory.source.tool": "工具",
  "memory.stat.entities": "实体",
  "memory.stat.events": "事件",
  "memory.stat.topics": "话题",
  "memory.state.active": "活跃",
  "memory.state.archived": "已归档",
  "memory.state.unknown": "未知",
  "memory.status.error.title": "记忆服务出错",
  "memory.status.loading": "正在加载记忆…",
  "memory.status.unavailable.description": "记忆服务运行在桌面应用内，浏览器预览或 Web 版本中不可用。",
  "memory.status.unavailable.title": "记忆服务未连接",
  "memory.tab.overview": "总览",
  "memory.landing.tagline": "记忆是沿着话题不断生长的脉络",
  "memory.landing.service.ready": "记忆服务就绪",
  "memory.landing.workbench": "工作台",
  "memory.landing.empty": "记忆星图会随着会话被记住而生长",
  "memory.landing.node.topic": "话题",
  "memory.landing.node.entity": "实体",
  "memory.landing.node.open": "打开 →",
  "memory.landing.card.newSession": "新建会话",
  "memory.landing.card.newSession.noProject": "先打开一个项目",
  "memory.landing.card.recent": "最近会话",
  "memory.landing.card.recent.count": "最近 {{count}} 个",
  "memory.landing.card.recent.empty": "还没有会话",
  "memory.landing.card.topics": "{{count}} 个话题 · {{incomplete}} 个待补标签",
  "memory.landing.card.graph": "{{entities}} 个实体 · {{relations}} 条关系",
  "memory.landing.card.graph.detail": "五类规范标签 · 有界两跳关联",
  "memory.landing.card.governance": "{{preferences}} 条偏好 · {{knowledge}} 条知识",
  "memory.landing.card.governance.detail": "{{receipts}} 条遗忘回执",
  "memory.tool.search": "检索记忆",
  "memory.tool.search.hits": "{{count}} 条命中",
  "memory.tool.recall": "恢复话题",
  "memory.tool.recall.current": "当前会话",
  "memory.tool.topics": "记忆话题",
  "memory.tool.topics.count": "{{count}} 个话题",
  "memory.tool.remember": "写入记忆",
  "memory.tool.remember.note": "笔记",
  "memory.tool.remember.preference": "偏好",
  "memory.tool.remember.knowledge": "知识",
  "memory.tool.remember.temporary": "临时",
  "memory.tool.checkpoint": "保存检查点",
  "memory.tool.forget": "遗忘记忆",
  "memory.tab.events": "事件",
  "memory.tab.governance": "治理",
  "memory.tab.graph": "图谱",
  "memory.tab.health": "状态",
  "memory.tab.topics": "话题",
  "memory.tagKind.other": "标签",
  "memory.tagKind.person": "人物",
  "memory.tagKind.time": "时间",
  "memory.topics.empty": "暂无话题",
  "memory.topics.entities": "共享实体",
  "memory.topics.eventCount": "{{count}} 个事件",
  "memory.topics.forget.action": "遗忘话题",
  "memory.topics.forget.confirm": "遗忘",
  "memory.topics.forget.description": "遗忘「{{title}}」及其下的全部事件？该操作会留下回执。",
  "memory.topics.forget.title": "遗忘这个话题？",
  "memory.topics.goal": "目标",
  "memory.topics.goal.empty": "该话题尚未记录目标。",
  "memory.topics.merge.action": "合并到其他话题",
  "memory.topics.merge.confirm": "合并",
  "memory.topics.merge.description": "把「{{title}}」的全部事件移入另一个话题，源话题保留指向目标的指针。",
  "memory.topics.merge.empty": "没有其他可合并的话题。",
  "memory.topics.merge.title": "合并话题",
  "memory.topics.searchPlaceholder": "筛选话题",
  "memory.topics.split.action": "拆分事件",
  "memory.topics.split.confirm": "拆分 {{count}} 条",
  "memory.topics.split.description": "把选中的事件从「{{title}}」拆分为新话题。",
  "memory.topics.split.namePlaceholder": "新话题标题",
  "memory.topics.split.title": "拆分话题",
  "memory.topics.summary": "摘要",
  "memory.topics.tags": "标签",
  "memory.topics.tags.empty": "尚未记录标签。",
  "memory.topics.timeline": "事件时间线",
  "memory.topics.updatedAt": "更新于 {{time}}",
  "memory.workspace.demo": "演示",
  "memory.workspace.label": "工作区",
  "memory.workspace.personal": "个人",
  "memory.workspace.switched": "已切换到{{workspace}}工作区",
  "settings.memory.backend.description": "记忆服务报告的嵌入模型，需在应用外部配置。",
  "settings.memory.backend.title": "嵌入后端",
  "settings.memory.indexPolicy.description": "草稿是否可检索，或仅准入标签完整的话题。",
  "settings.memory.indexPolicy.title": "检索准入",
  "settings.memory.liveRefresh.description": "打开记忆界面时轮询本地服务。",
  "settings.memory.liveRefresh.title": "实时刷新",
  "settings.memory.reindex.description": "根据已存储的事件重建向量与全文索引。",
  "settings.memory.reindex.title": "重建索引",
  "settings.memory.sessionTab.description": "在会话右侧，把记忆面板显示为「审查」「上下文」之外的页签。",
  "settings.memory.sessionTab.title": "会话记忆页签",
  "settings.memory.storage.description": "记忆数据库在本机的位置。",
  "settings.memory.storage.title": "存储",
  "settings.memory.workspace.description": "演示工作区存放合成样例，个人工作区存放真实记忆。",
  "settings.memory.workspace.title": "工作区",
  "memory.state.incomplete": "标签待补全",
  "memory.tagKind.resource": "资源",
  "memory.tagKind.keyword": "关键词",
  "memory.tagKind.vector": "向量",
  "memory.field.inputFiles": "输入文件",
  "memory.field.completedSteps": "已完成步骤",
  "memory.field.pendingSteps": "待办步骤",
  "memory.stat.incomplete": "待补全",
  "memory.tab.recent": "最近",
  "memory.recent.projects": "最近项目",
  "memory.recent.topics": "最近话题",
  "memory.recent.events": "最近事件",
  "memory.graph.openLive": "打开交互视图",
  "memory.graph.backToSnapshot": "返回快照",
  "memory.operation.kind.create_topic": "新建任务话题",
  "memory.operation.kind.bind_topic": "选择任务话题",
  "memory.operation.kind.remember": "保存记忆",
  "memory.operation.kind.rename_topic": "修改话题名称",
  "memory.operation.kind.checkpoint": "创建检查点",
  "memory.operation.kind.forget": "遗忘记忆",
  "memory.operation.kind.forget_field": "遗忘指定字段",
  "memory.operation.kind.move": "迁移事件",
  "memory.operation.kind.merge": "合并话题",
  "memory.operation.kind.split": "拆分话题",
  "memory.operation.kind.update_tags": "复核话题标签",
  "memory.operation.review.description": "请核对任务、操作范围和证据。确认前不会执行修改。",
  "memory.operation.create.description":
    "话题围绕持久任务或一系列任务组织，可跨多个会话。请说明目标与边界；缺少的人物、资源等信息留待补全。",
  "memory.operation.bind.description": "选择本次工作要继续的持久任务。此前未归属的消息不会自动导入。",
  "memory.operation.goal.placeholder": "说明这个任务的持续目标，以及包含哪些工作",
  "memory.operation.keywords": "最多 8 个有区分力的关键词，用逗号分隔（可选）",
  "memory.operation.pending": "{{count}} 项记忆操作待确认",
  "memory.operation.affected": "涉及已有事件：{{count}} 条",
  "memory.operation.reject": "取消操作",
  "memory.operation.field.topic": "话题",
  "memory.operation.field.source": "来源话题",
  "memory.operation.field.target": "目标",
  "memory.operation.field.event": "事件",
  "memory.operation.field.title": "任务名称",
  "memory.operation.field.project": "参考工程目录",
  "memory.operation.field.content": "内容",
  "memory.operation.field.key": "记忆键",
  "memory.operation.field.scope": "作用范围",
  "memory.operation.field.reason": "原因",
  "memory.operation.field.field": "字段",
  "memory.operation.field.session": "来源会话",
  "memory.operation.field.missing": "待补全标签类别",
  "memory.operation.tag.pending": "待确认",
  "memory.operation.tag.attribute": "仅作属性",
  "memory.operation.tag.accepted": "有来源",
  "memory.operation.kind.import_demo": "导入仿真工作记录",
  "memory.operation.field.topicsCount": "任务话题数",
  "memory.operation.field.eventsCount": "来源事件数",
  "memory.operation.import.description":
    "整合旧仿真记录与新任务轨迹。导入前自动备份，仅归档能够确认全部为旧仿真的话题；个人及混合记录保留。重复导入不重复创建。所有示例均为仿真。",
  "memory.operation.field.archiveCount": "将归档的旧仿真话题",
  "memory.operation.sources": "选择要纳入此任务的前序记录（可选，默认不选）",
  "memory.operation.field.removedTags": "将移除的标签",
