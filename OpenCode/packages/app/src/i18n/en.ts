...
export const dict = {
  ...
  "help.tabs.introduction": "MemPulse Code is built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of MemPulse Code ({{version}}) is ready to install.",
  ...
  "app.name.desktop": "MemPulse Code",
  ...
  "settings.general.row.language.description": "Change the display language of MemPulse Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customize how MemPulse Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description":
    "Choose whether MemPulse Code follows your system, light or dark theme",
  ...
  "command.memory.open": "Open memory workbench",
  "session.tab.memory": "Memory",
  "settings.tab.memory": "Memory",
  "memory.title": "Memory",
  "memory.action.cancel": "Cancel",
  "memory.action.confirm": "Confirm",
  "memory.action.more": "More actions",
  "memory.action.next": "Next",
  "memory.action.openWorkbench": "Open memory home",
  "memory.action.previous": "Previous",
  "memory.action.refresh": "Refresh",
  "memory.action.retry": "Try again",
  "memory.action.search": "Search memory",
  "memory.action.viewAll": "View all",
  "memory.contract.empty": "No restore contract recorded yet.",
  "memory.contract.missing": "Not captured",
  "memory.contract.more": "{{count}} more fields",
  "memory.contract.pending": "{{count}} fields still missing",
  "memory.contract.title": "Restore contract",
  "memory.events.app": "App",
  "memory.events.attributes": "Attributes",
  "memory.events.content": "Content",
  "memory.events.empty": "No events captured yet.",
  "memory.events.eventId": "Event",
  "memory.events.forget.action": "Forget event",
  "memory.events.forget.confirm": "Forget",
  "memory.events.forget.description":
    "The event is tombstoned: it stops appearing in search and restore, and the removal is recorded as a receipt.",
  "memory.events.forget.title": "Forget this event?",
  "memory.events.metadata": "Metadata",
  "memory.events.move.action": "Move to another topic",
  "memory.events.move.confirm": "Move",
  "memory.events.move.title": "Move event",
  "memory.events.olderHits": "Older matches",
  "memory.events.source": "Source",
  "memory.events.tool": "Tool",
  "memory.events.topic": "Topic",
  "memory.eventStatus.success": "Succeeded",
  "memory.eventStatus.failed": "Failed",
  "memory.eventStatus.pending": "Pending",
  "memory.eventStatus.unknown": "Unknown",
  "memory.field.other": "Field",
  "memory.field.outputPreference": "Output preference",
  "memory.field.templateVersion": "Template version",
  "memory.filter.all": "All",
  "memory.governance.checkpoints": "Checkpoints",
  "memory.governance.disputed": "Disputed",
  "memory.governance.empty": "Nothing recorded yet.",
  "memory.governance.knowledge": "Knowledge versions",
  "memory.governance.preferences": "Preferences",
  "memory.governance.receipts": "Forget receipts",
  "memory.governance.receipts.empty": "Nothing has been forgotten yet.",
  "memory.governance.scope": "Scope: {{scope}}",
  "memory.governance.supersedes": "Supersedes {{id}}",
  "memory.graph.clearSearch": "Clear search",
  "memory.graph.degree": "Connections",
  "memory.graph.empty": "Nothing to map yet",
  "memory.graph.empty.description": "The graph fills in as topics accumulate tags and shared entities.",
  "memory.graph.nodeList": "Nodes",
  "memory.graph.relatedTopics": "Connected topics",
  "memory.graph.relayout": "Run layout again",
  "memory.graph.searchPlaceholder": "Find a node",
  "memory.graph.selection": "Selection",
  "memory.graph.selection.empty": "Select a node for details. Drag to move it, scroll to zoom.",
  "memory.graph.summary": "{{topics}} topics · {{entities}} entities · {{relations}} relations",
  "memory.graph.zoomIn": "Zoom in",
  "memory.graph.zoomOut": "Zoom out",
  "memory.health.action.done": "Done",
  "memory.health.action.failed": "Failed",
  "memory.health.action.reindex": "Rebuild index",
  "memory.health.action.worker": "Run maintenance",
  "memory.health.backend": "Embedding backend",
  "memory.health.db": "Database",
  "memory.health.indexPolicy": "Retrieval admission",
  "memory.health.maintenance": "Maintenance",
  "memory.health.maintenance.hint":
    "These run against the local SQLite store. Rebuilding the index needs a configured local embedding model.",
  "memory.health.off": "Off",
  "memory.health.ok": "Healthy",
  "memory.health.on": "On",
  "memory.health.reindex.description":
    "Rebuilds the vector and full-text indexes from stored events. Needs a configured local embedding model and fails fast when none is loaded.",
  "memory.health.retrieval": "Retrieval",
  "memory.health.schema": "Schema",
  "memory.health.scope": "Scope",
  "memory.health.sdk": "Kylin SDK probe",
  "memory.health.sdk.backend": "Backend",
  "memory.health.sdk.dimension": "Dimension",
  "memory.health.sdk.message": "Message",
  "memory.health.sdk.model": "Model",
  "memory.health.sdk.none": "No Kylin SDK configured. Set MEMPULSE_KYLIN_SDK on the memory service to probe one.",
  "memory.health.sdk.status": "Status",
  "memory.health.service": "Service",
  "memory.health.storage": "Storage",
  "memory.health.topiccore": "TopicCore",
  "memory.health.workspace": "Workspace",
  "memory.route.ambiguous": "Ambiguous",
  "memory.route.attach": "Attached",
  "memory.route.new": "New",
  "memory.route.resume": "Resumed",
  "memory.route.unknown": "Unknown",
  "memory.search.empty": "No matches.",
  "memory.search.placeholder": "Search memory",
  "memory.session.captured": "Captured in this session",
  "memory.session.captured.empty": "Nothing captured yet. Events appear here as the session runs.",
  "memory.session.checkpoint.create": "Create checkpoint",
  "memory.session.checkpoint.revision": "Revision {{revision}}",
  "memory.session.checkpoint.title": "Checkpoint",
  "memory.session.noTopic.description":
    "Choose or create a persistent task topic and confirm it before this session contributes to long-term task memory.",
  "memory.session.noTopic.title": "No topic for this session yet",
  "memory.source.configuration": "Configuration",
  "memory.source.conversation": "Conversation",
  "memory.source.other": "Other",
  "memory.source.tool": "Tool",
  "memory.stat.entities": "Entities",
  "memory.stat.events": "Events",
  "memory.stat.topics": "Topics",
  "memory.state.active": "Active",
  "memory.state.archived": "Archived",
  "memory.state.unknown": "Unknown",
  "memory.status.error.title": "Memory service error",
  "memory.status.loading": "Loading memory…",
  "memory.status.unavailable.description":
    "The memory service runs inside the desktop app. It is not available in a browser preview or web build.",
  "memory.status.unavailable.title": "Memory service unavailable",
  "memory.tab.overview": "Overview",
  "memory.landing.tagline": "Memory grows along topics",
  "memory.landing.service.ready": "Memory service ready",
  "memory.landing.workbench": "Workbench",
  "memory.landing.empty": "The constellation fills in as sessions are remembered",
  "memory.landing.node.topic": "Topic",
  "memory.landing.node.entity": "Entity",
  "memory.landing.node.open": "Open",
  "memory.landing.card.newSession": "New session",
  "memory.landing.card.newSession.noProject": "Open a project to start",
  "memory.landing.card.recent": "Recent sessions",
  "memory.landing.card.recent.count": "{{count}} recent",
  "memory.landing.card.recent.empty": "Nothing yet",
  "memory.landing.card.topics": "{{count}} topics · {{incomplete}} need tags",
  "memory.landing.card.graph": "{{entities}} entities · {{relations}} relations",
  "memory.landing.card.graph.detail": "Five tag kinds, bounded two-hop map",
  "memory.landing.card.governance": "{{preferences}} preferences · {{knowledge}} knowledge",
  "memory.landing.card.governance.detail": "{{receipts}} forget receipts",
  "memory.tool.search": "Search memory",
  "memory.tool.search.hits": "{{count}} hits",
  "memory.tool.recall": "Recall topic",
  "memory.tool.recall.current": "this session",
  "memory.tool.topics": "Memory topics",
  "memory.tool.topics.count": "{{count}} topics",
  "memory.tool.remember": "Remember",
  "memory.tool.remember.note": "note",
  "memory.tool.remember.preference": "preference",
  "memory.tool.remember.knowledge": "knowledge",
  "memory.tool.remember.temporary": "temporary",
  "memory.tool.checkpoint": "Checkpoint",
  "memory.tool.forget": "Forget memory",
  "memory.tab.events": "Events",
  "memory.tab.governance": "Governance",
  "memory.tab.graph": "Graph",
  "memory.tab.health": "Status",
  "memory.tab.topics": "Topics",
  "memory.tagKind.other": "Tag",
  "memory.tagKind.person": "Person",
  "memory.tagKind.time": "Time",
  "memory.topics.empty": "No topics yet",
  "memory.topics.entities": "Shared entities",
  "memory.topics.eventCount": "{{count}} events",
  "memory.topics.forget.action": "Forget topic",
  "memory.topics.forget.confirm": "Forget",
  "memory.topics.forget.description":
    "Forget “{{title}}” and every event under it? The removal is recorded as a receipt.",
  "memory.topics.forget.title": "Forget this topic?",
  "memory.topics.goal": "Goal",
  "memory.topics.goal.empty": "No goal recorded for this topic.",
  "memory.topics.merge.action": "Merge into another topic",
  "memory.topics.merge.confirm": "Merge",
  "memory.topics.merge.description":
    "Move every event from “{{title}}” into another topic. The source keeps a pointer to where it went.",
  "memory.topics.merge.empty": "There is no other topic to merge into.",
  "memory.topics.merge.title": "Merge topic",
  "memory.topics.searchPlaceholder": "Filter topics",
  "memory.topics.split.action": "Split out events",
  "memory.topics.split.confirm": "Split {{count}}",
  "memory.topics.split.description": "Move the selected events out of “{{title}}” into a new topic.",
  "memory.topics.split.namePlaceholder": "New topic title",
  "memory.topics.split.title": "Split topic",
  "memory.topics.summary": "Summary",
  "memory.topics.tags": "Tags",
  "memory.topics.tags.empty": "No tags recorded yet.",
  "memory.topics.timeline": "Event timeline",
  "memory.topics.updatedAt": "Updated {{time}}",
  "memory.workspace.demo": "Demo",
  "memory.workspace.label": "Workspace",
  "memory.workspace.personal": "Personal",
  "memory.workspace.switched": "Switched to the {{workspace}} workspace",
  "settings.memory.backend.description": "The embedding model the memory service reports. Configured outside the app.",
  "settings.memory.backend.title": "Embedding backend",
  "settings.memory.indexPolicy.description":
    "Whether drafts stay searchable or only topics with complete tags are admitted.",
  "settings.memory.indexPolicy.title": "Retrieval admission",
  "settings.memory.liveRefresh.description": "Poll the local service while a memory surface is open.",
  "settings.memory.liveRefresh.title": "Live refresh",
  "settings.memory.reindex.description": "Rebuild the vector and full-text indexes from stored events.",
  "settings.memory.reindex.title": "Rebuild index",
  "settings.memory.sessionTab.description":
    "Show the memory panel as a tab beside Review and Context inside a session.",
  "settings.memory.sessionTab.title": "Session memory tab",
  "settings.memory.storage.description": "Where the memory database lives on this machine.",
  "settings.memory.storage.title": "Storage",
  "settings.memory.workspace.description": "Demo holds synthetic samples; personal holds your real memory.",
  "settings.memory.workspace.title": "Workspace",
  "memory.state.incomplete": "Tags missing",
  "memory.tagKind.resource": "Resource",
  "memory.tagKind.keyword": "Keyword",
  "memory.tagKind.vector": "Vector",
  "memory.field.inputFiles": "Input files",
  "memory.field.completedSteps": "Completed",
  "memory.field.pendingSteps": "Pending",
  "memory.stat.incomplete": "Tags missing",
  "memory.tab.recent": "Recent",
  "memory.recent.projects": "Recent projects",
  "memory.recent.topics": "Recent topics",
  "memory.recent.events": "Recent events",
  "memory.graph.openLive": "Open interactive view",
  "memory.graph.backToSnapshot": "Back to snapshot",
  "memory.operation.kind.create_topic": "Create task topic",
  "memory.operation.kind.bind_topic": "Choose task topic",
  "memory.operation.kind.remember": "Save memory",
  "memory.operation.kind.rename_topic": "Rename topic",
  "memory.operation.kind.checkpoint": "Create checkpoint",
  "memory.operation.kind.forget": "Forget memory",
  "memory.operation.kind.forget_field": "Forget a field",
  "memory.operation.kind.move": "Move event",
  "memory.operation.kind.merge": "Merge topics",
  "memory.operation.kind.split": "Split topic",
  "memory.operation.kind.update_tags": "Review topic tags",
  "memory.operation.review.description":
    "Review the task, scope and evidence below. Nothing changes until you confirm.",
  "memory.operation.create.description":
    "A topic follows a persistent task or series of tasks across sessions. Describe its goal and boundary; missing people or resources can be added later.",
  "memory.operation.bind.description":
    "Choose the persistent task this session continues. Earlier unassigned messages are not imported automatically.",
  "memory.operation.goal.placeholder": "Describe the ongoing goal and what belongs to this task",
  "memory.operation.keywords": "Up to 8 specific keywords, separated by commas (optional)",
  "memory.operation.pending": "{{count}} memory operations awaiting confirmation",
  "memory.operation.affected": "Affected existing events: {{count}}",
  "memory.operation.reject": "Cancel operation",
  "memory.operation.field.topic": "Topic",
  "memory.operation.field.source": "Source topic",
  "memory.operation.field.target": "Target",
  "memory.operation.field.event": "Event",
  "memory.operation.field.title": "Task title",
  "memory.operation.field.project": "Project directory",
  "memory.operation.field.content": "Content",
  "memory.operation.field.key": "Memory key",
  "memory.operation.field.scope": "Scope",
  "memory.operation.field.reason": "Reason",
  "memory.operation.field.field": "Field",
  "memory.operation.field.session": "Source session",
  "memory.operation.field.missing": "Missing tag classes",
  "memory.operation.tag.pending": "Needs review",
  "memory.operation.tag.attribute": "Attribute only",
  "memory.operation.tag.accepted": "Evidence-backed",
  "memory.operation.kind.import_demo": "Import realistic demo",
  "memory.operation.field.topicsCount": "Task topics",
  "memory.operation.field.eventsCount": "Source events",
  "memory.operation.import.description":
    "Combine legacy examples with authored work histories. A backup is made first; only wholly synthetic legacy topics are archived. Personal or mixed records stay intact. Re-importing does not duplicate the data.",
  "memory.operation.field.archiveCount": "Legacy synthetic topics to archive",
  "memory.operation.sources": "Choose earlier source records to include (optional)",
  "memory.operation.field.removedTags": "Tags to remove",
}
