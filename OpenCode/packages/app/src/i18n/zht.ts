...
export const dict = {
  ...
  "desktop.menu.ariaLabel": "MemPulse 選單",
  ...
  "desktop.recovery.loadFailed": "MemPulse 載入失敗",
  "desktop.recovery.terminated": "MemPulse 視窗意外終止",
  "desktop.recovery.unresponsive": "MemPulse 沒有回應",
  ...
  "help.tabs.introduction": "MemPulse Code 採用以分頁為核心的設計。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MemPulse Code 有新版本 ({{version}}) 可安裝。",
  ...
  "settings.general.row.language.description": "變更 MemPulse Code 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 MemPulse Code 在你裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 MemPulse Code 跟隨系統、淺色或深色主題",
  ...
  "command.memory.open": "開啟記憶工作台",
  "session.tab.memory": "記憶",
  "settings.tab.memory": "記憶",
  "memory.title": "記憶",
  "memory.tab.overview": "總覽",
  "memory.landing.tagline": "記憶是沿著話題不斷生長的脈絡",
  "memory.landing.service.ready": "記憶服務就緒",
  "memory.landing.workbench": "工作台",
  "memory.landing.empty": "記憶星圖會隨著會話被記住而生長",
  "memory.landing.node.topic": "話題",
  "memory.landing.node.entity": "實體",
  "memory.landing.node.open": "開啟 →",
  "memory.landing.card.newSession": "新建會話",
  "memory.landing.card.newSession.noProject": "先開啟一個專案",
  "memory.landing.card.recent": "最近會話",
  "memory.landing.card.recent.count": "最近 {{count}} 個",
  "memory.landing.card.recent.empty": "還沒有會話",
  "memory.landing.card.topics": "{{count}} 個話題 · {{incomplete}} 個待補標籤",
  "memory.landing.card.graph": "{{entities}} 個實體 · {{relations}} 條關係",
  "memory.landing.card.graph.detail": "五類規範標籤 · 有界兩跳關聯",
  "memory.landing.card.governance": "{{preferences}} 條偏好 · {{knowledge}} 條知識",
  "memory.landing.card.governance.detail": "{{receipts}} 條遺忘回執",
  "memory.tool.search": "檢索記憶",
  "memory.tool.search.hits": "{{count}} 條命中",
  "memory.tool.recall": "恢復話題",
  "memory.tool.recall.current": "當前會話",
  "memory.tool.topics": "記憶話題",
  "memory.tool.topics.count": "{{count}} 個話題",
  "memory.tool.remember": "寫入記憶",
  "memory.tool.remember.note": "筆記",
  "memory.tool.remember.preference": "偏好",
  "memory.tool.remember.knowledge": "知識",
  "memory.tool.remember.temporary": "臨時",
  "memory.tool.checkpoint": "儲存檢查點",
  "memory.tool.forget": "遺忘記憶",
  "memory.action.cancel": "取消",
  "memory.action.confirm": "确认",
  "memory.action.more": "更多操作",
  "memory.action.next": "下一页",
  "memory.action.openWorkbench": "開啟記憶首頁",
  "memory.action.previous": "上一页",
  "memory.action.refresh": "重新整理",
  "memory.action.retry": "重试",
  "memory.action.search": "搜索记忆",
  "memory.action.viewAll": "查看全部",
  "memory.contract.empty": "尚未記錄恢復契約。",
  "memory.contract.missing": "待补全",
  "memory.contract.more": "另有 {{count}} 個欄位",
  "memory.contract.pending": "還有 {{count}} 個欄位待補全",
  "memory.contract.title": "恢復契約",
  "memory.events.app": "应用",
  "memory.events.attributes": "屬性",
  "memory.events.content": "內容",
  "memory.events.empty": "尚未捕獲事件。",
  "memory.events.eventId": "事件",
  "memory.events.forget.action": "遺忘事件",
  "memory.events.forget.confirm": "遺忘",
  "memory.events.forget.description": "該事件將被標記為墓碑：不再出現在檢索與恢復結果中，刪除動作會留下回執。",
  "memory.events.forget.title": "遺忘這個事件？",
  "memory.events.metadata": "中繼資料",
  "memory.events.move.action": "移動到其他話題",
  "memory.events.move.confirm": "移動",
  "memory.events.move.title": "移動事件",
  "memory.events.olderHits": "更早的相符結果",
  "memory.events.source": "來源",
  "memory.events.tool": "工具",
  "memory.events.topic": "話題",
  "memory.eventStatus.success": "成功",
  "memory.eventStatus.failed": "失敗",
  "memory.eventStatus.pending": "進行中",
  "memory.eventStatus.unknown": "未知",
  "memory.field.other": "欄位",
  "memory.field.outputPreference": "輸出偏好",
  "memory.field.templateVersion": "範本版本",
  "memory.filter.all": "全部",
  "memory.governance.checkpoints": "檢查點",
  "memory.governance.disputed": "存疑",
  "memory.governance.empty": "尚無記錄。",
  "memory.governance.knowledge": "知識版本",
  "memory.governance.preferences": "偏好",
  "memory.governance.receipts": "遺忘回執",
  "memory.governance.receipts.empty": "尚無遺忘記錄。",
  "memory.governance.scope": "作用域：{{scope}}",
  "memory.governance.supersedes": "替代 {{id}}",
  "memory.graph.clearSearch": "清除搜尋",
  "memory.graph.degree": "關聯數",
  "memory.graph.empty": "暫無可繪製的內容",
  "memory.graph.empty.description": "隨著話題累積標籤與共享實體，圖譜會逐步展開。",
  "memory.graph.nodeList": "節點",
  "memory.graph.relatedTopics": "關聯話題",
  "memory.graph.relayout": "重新佈局",
  "memory.graph.searchPlaceholder": "尋找節點",
  "memory.graph.selection": "選取項",
  "memory.graph.selection.empty": "選取一個節點查看詳情。拖曳可移動節點，滾輪可縮放。",
  "memory.graph.summary": "{{topics}} 個話題 · {{entities}} 個實體 · {{relations}} 條關係",
  "memory.graph.zoomIn": "放大",
  "memory.graph.zoomOut": "縮小",
  "memory.health.action.done": "已完成",
  "memory.health.action.failed": "操作失敗",
  "memory.health.action.reindex": "重建索引",
  "memory.health.action.worker": "執行維護",
  "memory.health.backend": "嵌入後端",
  "memory.health.db": "資料庫",
  "memory.health.indexPolicy": "檢索准入",
  "memory.health.maintenance": "維護",
  "memory.health.maintenance.hint": "以下操作作用於本機 SQLite 儲存。重建索引需要已設定的本機嵌入模型。",
  "memory.health.off": "關",
  "memory.health.ok": "正常",
  "memory.health.on": "開",
  "memory.health.reindex.description":
    "根據已儲存的事件重建向量與全文索引。需要已設定的本機嵌入模型，未載入時會直接失敗。",
  "memory.health.retrieval": "檢索",
  "memory.health.schema": "Schema 版本",
  "memory.health.scope": "作用域",
  "memory.health.sdk": "麒麟 SDK 探測",
  "memory.health.sdk.backend": "後端",
  "memory.health.sdk.dimension": "維度",
  "memory.health.sdk.message": "訊息",
  "memory.health.sdk.model": "模型",
  "memory.health.sdk.none": "未設定麒麟 SDK。在記憶服務上設定 MEMPULSE_KYLIN_SDK 後即可探測。",
  "memory.health.sdk.status": "狀態",
  "memory.health.service": "服務",
  "memory.health.storage": "儲存",
  "memory.health.topiccore": "TopicCore",
  "memory.health.workspace": "工作區",
  "memory.route.ambiguous": "待判定",
  "memory.route.attach": "已掛載",
  "memory.route.new": "新建",
  "memory.route.resume": "已恢復",
  "memory.route.unknown": "未知",
  "memory.search.empty": "沒有相符結果。",
  "memory.search.placeholder": "搜尋記憶",
  "memory.session.captured": "本次工作階段已捕獲",
  "memory.session.captured.empty": "尚未捕獲內容。工作階段進行時，事件會出現在這裡。",
  "memory.session.checkpoint.create": "建立檢查點",
  "memory.session.checkpoint.revision": "版本 {{revision}}",
  "memory.session.checkpoint.title": "檢查點",
  "memory.session.noTopic.description":
    "請選擇或建立持久任務話題，並確認關聯。工作階段建立與首則訊息不會自動建立話題。",
  "memory.session.noTopic.title": "本次工作階段尚無話題",
  "memory.source.configuration": "設定",
  "memory.source.conversation": "對話",
  "memory.source.other": "其他",
  "memory.source.tool": "工具",
  "memory.stat.entities": "實體",
  "memory.stat.events": "事件",
  "memory.stat.topics": "話題",
  "memory.state.active": "活躍",
  "memory.state.archived": "已歸檔",
  "memory.state.unknown": "未知",
  "memory.status.error.title": "記憶服務出錯",
  "memory.status.loading": "正在載入記憶…",
  "memory.status.unavailable.description": "記憶服務執行於桌面應用程式內，瀏覽器預覽或 Web 版本中無法使用。",
  "memory.status.unavailable.title": "記憶服務未連線",
  "memory.tab.events": "事件",
  "memory.tab.governance": "治理",
  "memory.tab.graph": "圖譜",
  "memory.tab.health": "狀態",
  "memory.tab.topics": "話題",
  "memory.tagKind.other": "標籤",
  "memory.tagKind.person": "人物",
  "memory.tagKind.time": "時間",
  "memory.topics.empty": "尚無話題",
  "memory.topics.entities": "共享實體",
  "memory.topics.eventCount": "{{count}} 個事件",
  "memory.topics.forget.action": "遺忘話題",
  "memory.topics.forget.confirm": "遺忘",
  "memory.topics.forget.description": "遺忘「{{title}}」及其下的全部事件？該操作會留下回執。",
  "memory.topics.forget.title": "遺忘這個話題？",
  "memory.topics.goal": "目標",
  "memory.topics.goal.empty": "該話題尚未記錄目標。",
  "memory.topics.merge.action": "合併到其他話題",
  "memory.topics.merge.confirm": "合併",
  "memory.topics.merge.description": "把「{{title}}」的全部事件移入另一個話題，來源話題保留指向目標的指標。",
  "memory.topics.merge.empty": "沒有其他可合併的話題。",
  "memory.topics.merge.title": "合併話題",
  "memory.topics.searchPlaceholder": "篩選話題",
  "memory.topics.split.action": "拆分事件",
  "memory.topics.split.confirm": "拆分 {{count}} 條",
  "memory.topics.split.description": "把選取的事件從「{{title}}」拆分為新話題。",
  "memory.topics.split.namePlaceholder": "新話題標題",
  "memory.topics.split.title": "拆分話題",
  "memory.topics.summary": "摘要",
  "memory.topics.tags": "標籤",
  "memory.topics.tags.empty": "尚未記錄標籤。",
  "memory.topics.timeline": "事件時間軸",
  "memory.topics.updatedAt": "更新於 {{time}}",
  "memory.workspace.demo": "示範",
  "memory.workspace.label": "工作區",
  "memory.workspace.personal": "個人",
  "memory.workspace.switched": "已切換到{{workspace}}工作區",
  "settings.memory.backend.description": "記憶服務回報的嵌入模型，需在應用程式外部設定。",
  "settings.memory.backend.title": "嵌入後端",
  "settings.memory.indexPolicy.description": "草稿是否可檢索，或僅准入標籤完整的話題。",
  "settings.memory.indexPolicy.title": "檢索准入",
  "settings.memory.liveRefresh.description": "開啟記憶介面時輪詢本機服務。",
  "settings.memory.liveRefresh.title": "即時重新整理",
  "settings.memory.reindex.description": "根據已儲存的事件重建向量與全文索引。",
  "settings.memory.reindex.title": "重建索引",
  "settings.memory.sessionTab.description": "在工作階段右側，把記憶面板顯示為「審查」「上下文」之外的頁籤。",
  "settings.memory.sessionTab.title": "工作階段記憶頁籤",
  "settings.memory.storage.description": "記憶資料庫在本機的位置。",
  "settings.memory.storage.title": "儲存",
  "settings.memory.workspace.description": "示範工作區存放合成範例，個人工作區存放真實記憶。",
  "settings.memory.workspace.title": "工作區",
  "memory.state.incomplete": "標籤待補全",
  "memory.tagKind.resource": "資源",
  "memory.tagKind.keyword": "關鍵詞",
  "memory.tagKind.vector": "向量",
  "memory.field.inputFiles": "輸入檔案",
  "memory.field.completedSteps": "已完成步驟",
  "memory.field.pendingSteps": "待辦步驟",
  "memory.stat.incomplete": "待補全",
  "memory.tab.recent": "最近",
  "memory.recent.projects": "最近專案",
  "memory.recent.topics": "最近話題",
  "memory.recent.events": "最近事件",
  "memory.graph.openLive": "開啟互動檢視",
